function [indices, startCapped, endCapped] = ADTimeToIndices(obj, timeRange)
...
if timeRange(1) < obj.ADStartTime
	timeRange(1) = obj.ADStartTime;
	startCapped = true;
else
	startCapped = false;
end
if timeRange(2) > obj.ADEndTime
	timeRange(2) = obj.ADEndTime;
	endCapped = true;
else
	endCapped = false;
end
...
% 1 based indexing.
indices = round((timeRange - obj.ADStartTime) * obj.ADFrequency) + 1;
